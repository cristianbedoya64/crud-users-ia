...
Cada cambio funcional, técnico o de seguridad realizado en el frontend será documentado en el changelog ([../docs/CHANGELOG.md](../docs/CHANGELOG.md)) y en los archivos relevantes. Esto garantiza trazabilidad y evidencia para la evaluación académica y profesional.
<br><br>
