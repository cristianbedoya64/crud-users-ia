...
## 1.5 Criterios de Éxito de Demo / Demo Success Criteria
<img src="https://flagcdn.com/es.svg" alt="Español" width="20" height="13"> **Español:**
**Guion reproducible (10–12 min):**
1. Login seguro y acceso al dashboard.
2. Creación y edición de usuarios, roles y permisos.
3. Asignación de roles y permisos a usuarios.
4. Visualización y filtrado de logs de auditoría.
5. Acceso y uso del panel IA.
6. Validación de restricciones de acceso y error controlado.
7. Demostración de backup y restauración.
8. Consulta de documentación técnica y despliegue reproducible.
Cada paso evidencia trazabilidad, seguridad y disponibilidad operativa.
<br><br>
<img src="https://flagcdn.com/us.svg" alt="English" width="20" height="13"> **English:**
**Reproducible script (10–12 min):**
1. Secure login and dashboard access.
2. Create/edit users, roles, and permissions.
3. Assign roles and permissions to users.
4. View and filter audit logs.
5. Access and use the AI panel.
6. Validate access restrictions and controlled error handling.
7. Demonstrate backup and restore.
8. Review technical documentation and reproducible deployment.
Each step demonstrates traceability, security, and operational availability.
