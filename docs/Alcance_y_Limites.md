...
- Seguridad mínima: JWT, RBAC, CORS, rate limit.
...
- Traceability: audit logs, action/change history.
- Operational availability: reproducible deployment in Docker/Codespaces.
- Documentation: deployment, restore, and API guides.
...
- No integration with external enterprise systems.
- No advanced monitoring or automatic alerts.

---

## 1.5 Criterios de Éxito de Demo / Demo Success Criteria
<img src="https://flagcdn.com/es.svg" alt="Español" width="20" height="13"> **Español:**
- Login seguro y acceso al dashboard.
...
- CRUD management of users, roles, and permissions.
- Assignment and validation of roles/permissions.
- View and filter audit logs.
- Access and use the AI panel.
- Validate restrictions and controlled errors.
- Backup/restore and documentation review.
