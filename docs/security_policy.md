...
Every change affecting security, architecture, or functionality will be documented in the changelog ([docs/CHANGELOG.md](docs/CHANGELOG.md)) and in this file if relevant. This ensures traceability and evidence for academic and professional evaluation.
